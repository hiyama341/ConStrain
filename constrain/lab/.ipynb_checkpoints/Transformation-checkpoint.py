...
def transf_locations1(reaction_names, reaction_participants, wanted_amounts, water_dna_p_reac, media = ''):
    ...
    ''' This function makes a pandas dataframe of the parts(their location) that needs to be put into the transformation mixes
        ...
        transf_locations1(reaction_names, reaction_participants, wanted_concentration = wanted_concentrations, water_dna_p_reac = 7, media = media)
...
def time_to_inculate(initialOD = 0.0025, td=0.4, verbose=False, innoculation_time:str = 10):
    ...
    print("Assumed that: ")
    print("- transformation time " +transformationstime  +" (reached OD=1 the day after)")
    ...
    def inoculation_time(times,ods):
        ...
        inoculation_time = 11 + 24 - hours_to_OD1
        print("Time of inoculation: \t" + str(inoculation_time) + "(the day before)")
