...
results_1st_ana <- tibble(abs_path = list.files(here("data","raw","023_LC-MS"), full.names = TRUE, pattern = ".csv"))  %>%
...
![Labchip results](/Users/Christine/Documents/Speciale/g8h_cpr_library/data/raw/009_LabChip/YP49_G8H2_NNFCB-LABCHIP_g8h_cpr_library_2021-06-30_12-12-51_Gel copy.png)
Søren:
...
- Output from jupyterlab 05-SDP-AllLibraries for first transformation round
...
*** Conclusion:
We see that there are 10 out of the 20 that are not included to ML! Therefore the top 20 producers that were not included should be resequenced. 
