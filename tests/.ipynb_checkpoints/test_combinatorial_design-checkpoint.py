...
for seq_record in SeqIO.parse('test_files/promoter_test_data.fasta', format= 'fasta'):
    promoter.append(seq_record)
for seq_record in SeqIO.parse('test_files/CDS_test_data.fasta', format= 'fasta'):
    cds.append(seq_record)
for seq_record in SeqIO.parse('test_files/terminator_test_data.fasta', format= 'fasta'):
